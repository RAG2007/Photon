...
int main()
{
	...
	int queue_count = queue_create_infos[0].queueFamilyIndex == queue_create_infos[1].queueFamilyIndex ? 1 : 2;

	VkDevice l_device;
	if(create_logical_device(p_device, instance, queue_count, queue_create_infos,
